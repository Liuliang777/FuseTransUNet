...
#     para_4.append(float(num.split(',')[6]))
...
# popt2,pcov2 = curve_fit(gaussian,para_1,para_4,p0=[3,4,3,6,1,1],maxfev=500000)
# popt3,pcov3 = curve_fit(gaussian,para_1,para_3,p0=[3,4,3,6,1,1],maxfev=500000)
plt.figure()

# acc
# plt.plot(para_1, para_2, 'k', label='train_loss' )#r对应颜色   A对应的标签名字
plt.plot(para_1, gaussian(para_1, *popt), 'g', label='train_miou')
plt.plot(para_1, gaussian(para_1, *popt1), 'b', label='val_miou')
# plt.plot(para_1,gaussian(para_1,*popt2),'k',label='fwiou')
# loss
